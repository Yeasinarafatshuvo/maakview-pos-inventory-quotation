                    ...
                    <table class="text-right sm-padding" style="border-collapse:collapse">
                        <tbody>
                            ...
                            @php
                                ...
                                $total_discount =  100 - (($subtotal-$order->special_discount) * 100) / $subtotal;  
                            ...
                            <tr>
                                ...
                                <td class="bold" style="border-bottom:1px solid #DEDEDE;font-size:14px;line-height: 1px; margin-bottom:0px">
                                    {{ format_price(($subtotal+$order->orderDetails['0']->tax + $order->shipping_cost) - ($order->special_discount + ($order->advance_payment == null? 0: $order->advance_payment))) }}
                                </td>
                            </tr>
                            <tr>
