                    ...
                    <div class="shipping">
                        <div class="container-fluid d-flex">
                            <div class="category_search flex-fill p-1 mb-3">
                               <input type="text" class="form-control" id="customer_serch_id" placeholder="Search By Customer Phone">
                               <div id="suggesstion-box_customer"></div>
                            </div>
                                ...
                                <table class="table table-bordered text-center">
                                    ...
                                    <tbody id="append_div2" >          
                                        <tr id="data-row-id" class="data-row-class text-center product_row">
                                            ...
                                            <td><input id="tax_input" type="text" min="1" name="tax" class="form-control tax"  value=""></td>
                                            <td><input id="shipping_cost_input" type="text" min="1" name="shipping_cost" class="form-control shipping_cost"  value=""></td>
                                            <td><input id="dicount_input" type="text" min="1" name="special_discount" class="form-control discount" value=""></td>
...
<script type="text/javascript">
    var multiply;
                            ...
                            success: function (response) {
                                ...
                                var row =
                                        '<tr id="data-row-id" class="data-row-class product_row_'+inc+' common_class">\
                                            ...
                                            <td style="width:82px;"><span class="qty_span_class_'+response.match_products.data[0].id+'"></span><input id="qty_input" type="hidden" name="product_qty[]"  class="form-control qty_'+inc+' check_min_qty qty_unique_class_'+response.match_products.data[0].id+'"  value="1"></td>\
        ...
        $('.save_order').on('click', function (e) {
            ...
            if(($('#customer_id').val()) && $('.data-row-class').length !== 1 && shipped_validation){
                $.ajax({
                    type: "POST",
...
$("#shipping_cost_input").keyup(function (e) { 
  var product_row_length = $('.common_class').length;
  if(product_row_length >= 1){
    var shipping_cost_value = $(this).val();
